...
const Game = {
    ...
    checkWinCondition: function() {
        ...
        if (this.player1.score >= WINNING_SCORE) {
            ...
            setTimeout(function() { Pong.endGameMenu(message); }, 1000);
        } else if (this.mode === GAME_MODES.MULTIPLAYER && this.player3.score >= WINNING_SCORE) {
            this.over = true;
            setTimeout(function() { Pong.endGameMenu('Bottom Player Wins!'); }, 1000);
        }
        ...
        if (this.mode === GAME_MODES.MULTIPLAYER) {
            if (this.player1.score >= WINNING_SCORE && this.player2.score >= WINNING_SCORE) {
                this.over = true;
                setTimeout(function() { Pong.endGameMenu('Left and Right Players Win!'); }, 1000);
            } else if (this.player1.score >= WINNING_SCORE && this.player3.score >= WINNING_SCORE) {
                this.over = true;
                setTimeout(function() { Pong.endGameMenu('Left and Bottom Players Win!'); }, 1000);
            } else if (this.player2.score >= WINNING_SCORE && this.player3.score >= WINNING_SCORE) {
                this.over = true;
                setTimeout(function() { Pong.endGameMenu('Right and Bottom Players Win!'); }, 1000);
            }
        }
    },
