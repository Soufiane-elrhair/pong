...
const Game = {
    ...
    checkWinCondition: function() {
        ...
        if (this.player1.score >= WINNING_SCORE) {
            this.gameOver('Left Player Wins!');
            ...
            this.gameOver('Bottom Player Wins!');
        }
